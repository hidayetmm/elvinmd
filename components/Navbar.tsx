        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex gap-6 items-center opacity-80">
            <a href="#" className="flex items-center gap-1.5 hover:opacity-100 transition-opacity">
              <MapPin size={14} />
              <span>28 Nizami St, Baku, Azerbaijan</span>
            </a>
            <a href="mailto:dr.hasanli@elvinmd.az" className="flex items-center gap-1.5 hover:opacity-100 transition-opacity">
              <Mail size={14} />
              <span>dr.hasanli@elvinmd.az</span>
            </a>
          </div>
      ...
      <nav className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white shadow-lg py-3' : 'bg-white py-5'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <div className="font-display text-xl font-semibold text-primary leading-tight">Dr. Elvin Hasanli</div>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a href="tel:+994501234567" className="flex items-center gap-2 text-sm text-primary font-medium">
              <Phone size={15} />
              +994 50 123-45-67
            </a>
            <Link href="/contact" className="bg-primary text-white text-sm font-medium px-5 py-2.5 rounded-full hover:bg-accent transition-colors duration-300">
              Book Appointment
            </Link>
          </div>
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-300 ${open ? 'max-h-96' : 'max-h-0'}`}>
          <div className="bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4">
            ...
            <Link href="/contact" onClick={() => setOpen(false)} className="bg-primary text-white text-sm font-medium px-5 py-3 rounded-full text-center mt-2">
              Book Appointment
            </Link>
          </div>
        </div>
